    ...
    <>
      <section>
        <div className="aboutSectionParent">
          ...
          <div className="py-2">
            <p>
              Hailing from Sangli, India, I'm a passionate Full Stack Developer
              with a strong foundation in both frontend and backend
              technologies. My focus is on crafting user-friendly interfaces
              that are not only visually appealing but also intuitive and easy
              to navigate.
            </p>
